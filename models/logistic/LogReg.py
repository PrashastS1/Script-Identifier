...
data_dir = os.path.join(script_dir, "../../data/recognition/")
train_csv = os.path.join(data_dir, "train.csv")
test_csv = os.path.join(data_dir, "test.csv")
log_file = os.path.join(script_dir, "script_log1.txt")

LMap = {
    1: "assamese", 2: "bengali", 3: "english", 4: "gujarati", 5: "hindi", 6: "kannada",
    7: "malayalam", 8: "marathi", 9: "punjabi", 10: "tamil", 11: "telugu", 12: "urdu"
}
...
save_plot_with_legend(x_train, y_train, model, selected_lang)
